    ...
    internal class DroneOptions : OptionInterface
    {
        ...
        public override void Initialize()
        {
                ...
                Tabs[i].AddItems(new UIelement[]
            {
                ...
                new OpImage(new Vector2(306f,408f), "artieye") {color = eyeColors[i].Value, scale = new Vector2(2f,2f)},
                new OpImage(new Vector2(306f,408f), "artiedge") {color = antColors[i].Value, scale = new Vector2(2f,2f)},
                new OpImage(new Vector2(306f,408f), "artibottom") {color = bottomColors[i].Value, scale = new Vector2(2f,2f)},
                new OpImage(new Vector2(306f,408f), "artibody") {color = bodyColors[i].Value, scale = new Vector2(2f,2f)},
